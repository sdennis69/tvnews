...
const resourceLinks = [
  ...
  { label: "About Us", href: "/about-wway" },
  { label: "Contact", href: "/about-wway/contact-us" },
]
    ...
    <footer style={{ background: "var(--gradient-navy)", color: "hsl(var(--primary-foreground))" }}>
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed opacity-75">
              Wilmington, NC&apos;s trusted source for local news, weather, and sports. ABC, CBS &amp; CW affiliate.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/wwaytv3" target="_blank" rel="noopener noreferrer" aria-label="WWAYTV3 on Facebook"
                className="h-8 w-8 rounded flex items-center justify-center transition-colors"
                style={{ background: "rgba(255,255,255,0.1)" }}>
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://twitter.com/WWAYTV3" target="_blank" rel="noopener noreferrer" aria-label="WWAYTV3 on Twitter"
                className="h-8 w-8 rounded flex items-center justify-center transition-colors"
                style={{ background: "rgba(255,255,255,0.1)" }}>
              ...
              <a href="https://www.youtube.com/user/wwaytv3" target="_blank" rel="noopener noreferrer" aria-label="WWAYTV3 on YouTube"
                className="h-8 w-8 rounded flex items-center justify-center transition-colors"
                style={{ background: "rgba(255,255,255,0.1)" }}>
        ...
        <div className="pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs opacity-60"
          ...
          <p>&copy; {YEAR} WWAYTV3. All rights reserved. Wilmington, NC.</p>
          <div className="flex gap-5">
            <Link href="/about-wway/privacy-policy">
