...
export default function FeaturedStory() {
  return (
    <div className="bg-[#ffffff] rounded-lg overflow-hidden shadow-lg-custom">
      {/* Featured Image */}
      ...
      <div className="p-6">
        <div className="flex items-center gap-2 mb-3">
          <span className="bg-[#cc0000] text-white text-xs font-bold px-3 py-1 rounded">
            LOCAL NEWS
          </span>
          <span className="text-[#999999] text-xs">2 hours ago</span>
        </div>

        <h2 className="text-2xl font-bold text-white mb-3 leading-tight hover:text-[#cc0000] transition-smooth">
        ...
        <div className="flex items-center justify-between text-xs text-[#999999]">
          ...
          <Link href="#" className="text-[#cc0000] hover:text-[#990000] font-semibold">
